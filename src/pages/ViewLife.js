  ...
  return (
    <div className="App">
      ...
      <div className='mainmenu'>
        ...
        <div>{userInput}</div>
        <div style={{fontSize:"16px", textAlign:"left", marginBottom:"30px", marginLeft:"-40px", marginRight:"-40px", padding:"2px", backgroundColor:menuBackgroundColor, fontWeight:"700"}}>
