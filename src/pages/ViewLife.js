  ...
  return (
    <div className="App">
      ...
      <div className='mainmenu'>
        ...
        <div>{userInput}</div>
        <div style={{fontSize:"20px", textAlign:"left", marginBottom:"30px", marginLeft:"-50px", marginRight:"-50px", padding:"10px", backgroundColor:menuBackgroundColor, fontWeight:"700"}}>
