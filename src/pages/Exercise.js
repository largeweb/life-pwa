  ...
  return (
    <div className="App background">
      ...
      <div className='mainmenu' id="maindiv">
        ...
        {locked=="true"
        ? <div><button style={{border:"3px solid black", fontSize:"10px", width:"40%", borderRadius:"30%"}} value={locked} onClick={(e) => setLocked(!eval(locked))}>Exercise Mode On<br></br>🔒</button></div>
        : <div><button style={{border:"3px solid black", width:"50%", borderRadius:"10%"}} value={locked} onClick={(e) => setLocked(!eval(locked))}>Exercise Mode Off</button></div>
        }
        {locked=="true"
        ? <div />
        : <div><div style={{border:"5px solid black", width:"50%", borderRadius:"10%", marginLeft:"25%", backgroundColor:"lightgray"}} value={locked} onClick={(e) => setAllExerciseToZero()}>Reset All</div></div>
        }
        <hr></hr>
        {locked=="true"
        ? <div />
