  ...
  return (
    <div className="App background">
      ...
      <div className='mainmenu' id="maindiv">
        ...
        <button className='menubutton' onClick={(e) => changewallpaperfetch('retro-green.jpg')} style={{backgroundImage: `url(${retrogreen})`, backgroundSize:"100px"}}><span style={{backgroundColor:"white", opacity:"0.5", padding:"5px", width:"80%"}}>Retro Green</span></button>
        <button className='menubutton' onClick={(e) => changewallpaperfetch('blue-grid.jpg')} style={{backgroundImage: `url(${bluegrid})`, backgroundSize:"100px"}}><span style={{backgroundColor:"white", opacity:"0.5", padding:"5px", width:"80%"}}>Blue Grid</span></button>
        <button className='menubutton' style={{backgroundImage: `url(${redwave})`, backgroundSize:"100px"}} onClick={(e) => changewallpaperfetch('red-wave.jpg')}><span style={{backgroundColor:"white", opacity:"0.5", padding:"5px", width:"80%"}}>Red Wave</span></button>
