  ...
  return (
    ...
    <div>
        ...
        {/* <div style={{textAlign: "center"}}> */}
          <Link to={'/'}><button style={{left:"10%", width:"38%", position:"fixed", height:"50px"}}>🤖 BACK 🤖</button></Link>
          <Link to={'/'}><button style={{right:"10%", width:"38%", position:"fixed", height:"50px"}}>🤖 BACK 🤖</button></Link>
